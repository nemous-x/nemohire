...
4. **Extract, don't rewrite.** For each posting pull: title, company, location, salary (if listed), full description, requirements, posting URL, and application URL. Copy description text verbatim — do not summarize or rephrase it at this stage; ranking and prepare steps need the original text.
