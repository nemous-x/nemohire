...
5. **Interview library.** Draft reusable first-person answers for: tell me about yourself, why this company, why this role, strengths, weaknesses, a leadership example, a conflict example, and the biggest achievement. Mark these as drafts — `identity-agent` refines them per-job, live, during `/nemo:apply`.
